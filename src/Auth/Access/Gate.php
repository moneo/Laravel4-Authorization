...
class Gate implements GateContract
{
    ...
    public function check($abilities, $arguments = [])
    {
        ...
        $collection->push($abilities);

        return $collection->every(function ($ability) use ($arguments) {
            try {
    ...
    public function any($abilities, $arguments = [])
    {
        ...
        return $collection->contains(function ($ability) use ($arguments) {
            return $this->check($ability, $arguments);
        });
    }
     ...
     *
     * @param  \Moneo\Authorization\Contracts\Auth\Authenticatable|null $user
     ...
     *
     * @param  \Moneo\Authorization\Contracts\Auth\Authenticatable $user
     * @param  string $ability
     * @param  array $arguments
     * @param  bool $result
     * @return bool|null
    ...
    protected function resolveAuthCallback($user, $ability, array $arguments)
    {
        ...
        if (isset($this->stringCallbacks[$ability])) {
            list($class, $method) = Str::parseCallback($this->stringCallbacks[$ability]);
    ...
    protected function guessPolicyName($class)
    {
        if ($this->guessPolicyNamesUsingCallback) {
            return $this->wrap(call_user_func($this->guessPolicyNamesUsingCallback, $class));
        }
     ...
     *
     * @param  \Moneo\Authorization\Contracts\Auth\Authenticatable|mixed $user
     * @return static
     */
